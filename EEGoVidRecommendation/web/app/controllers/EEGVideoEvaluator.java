...
public class EEGVideoEvaluator {
	...
	public static void main(String[] args) throws Exception {
		...
		//DataModel dataModel = InterestLevelDataModel.generateDataModel(1, args[0]);
		/********** Uncomment the line to run the demo you like **********/
		//System.out.println("Got Here 1");
		//ArrayList<String> tempString = runUserBasedRecommender(dataModel);
	...
	public static void runALSSVDRecommender(DataModel dataModel)
	...
	public static ArrayList<String> runUserBasedRecommender(DataModel dataModel)
			throws TasteException {
		...
		for (LongPrimitiveIterator users = dataModel.getUserIDs(); users
			...
			for (RecommendedItem recommendation : recommendations) {
				...
				returnString=Long.toString(userId)+ "," + Long.toString(recommendation.getItemID())
						+ "," + Float.toString(recommendation.getValue());
				theList.add(returnString);
		...
		theList.add(Double.toString(score));
		// Recommender Evaluation -- RMS Evaluator
		RecommenderEvaluator rmsEvaluator = new RMSRecommenderEvaluator();
		double rmsscore = rmsEvaluator.evaluate(recommenderBuilder, null,
				dataModel, 0.7, 0.3);
		System.out.println("User-based Recommende RMS Score is:" + rmsscore);
		theList.add(Double.toString(rmsscore));
		// Recommender Evaluation -- IRStats Evaluator
		RecommenderIRStatsEvaluator irStatsEvaluator = new GenericRecommenderIRStatsEvaluator();
		IRStatistics stats = irStatsEvaluator.evaluate(recommenderBuilder,
...
return theList;
	...
	public static void runItemBasedRecommender(DataModel dataModel)
			throws TasteException {
	...
	public static void runItemBasedDemo(DataModel dataModel,
	...
	public static void runUserRecommender(DataModel dataModel, int n,
